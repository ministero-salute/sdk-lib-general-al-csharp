...
namespace AccessLayerMdS.AVN.SR
{
    /// <summary>
    /// A Core logic for interfacing with API Gateway for flux AVN SOMM RESIDENTI.
    /// </summary>
    public class AccessLayer : AccessLayerCore
    {
        public AccessLayer() : base("FLUSSO_AVN_SOM_RESIDENTI")
        {
        }
