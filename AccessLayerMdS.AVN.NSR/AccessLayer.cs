...
namespace AccessLayerMdS.AVN.NSR
{
    /// <summary>
    /// A Core logic for interfacing with API Gateway for flux AVN NON SOMMINISTRATI RESIDENTI.
    /// </summary>
    public class AccessLayer : AccessLayerCore
    {
        public AccessLayer() : base("avn-non-som-res")
        {
        }
